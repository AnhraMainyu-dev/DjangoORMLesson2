...
- `YANDEX_API_KEY` - API-ключ к сервису Яндекс-геокодера. Необходим для рассчёта расстояния от ресторана к адресу заказа. Получить можно в [кабинете разработчика Яндека](developer.tech.yandex.ru),
